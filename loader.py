...
def load_data(datatype):
	...
	for edge in edges:
	 ...
	 #TODO
	# print("prev constraints",constraints)
	assembly_graph, constraints, ground_truth_dict, Gx ,filtered_node = filter_isolatedNodes(assembly_graph,constraints,edges,ground_truth_dict,Gx)
	# print("------------------------------------")
	# print("after constraints",constraints)
	return assembly_graph, constraints, ground_truth_dict, Gx , filtered_node
...
def filter_isolatedNodes(assembly_graph, constraints, edges, ground_truth_dict, Gx):
	...
	for idx in range(assembly_graph.shape[0]):
		if Gx.degree(idx) == 0:
			isoNodes.append(idx)
	# print("isoNodes",isoNodes)
	filtered_node = isoNodes
	...
	return adj_sp, newConstraints, newGroundTruth, Gx , filtered_node
